 ...
 */
bool nss_wifi_mesh_verify_if_num(uint32_t if_num)
{
 ...
 */
void nss_wifi_mesh_msg_init(struct nss_wifi_mesh_msg *nwm, uint32_t if_num, uint32_t type, uint32_t len,
 ...
 */
nss_tx_status_t nss_wifi_mesh_tx_buf(struct nss_ctx_instance *nss_ctx, struct sk_buff *os_buf, uint32_t if_num)
{
